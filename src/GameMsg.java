public class GameMsg {
    ...
    public static final String DEALERS_CARDS="ディーラーの手札：";
    public static final String ASK_DRAW_CARD="カードを引きますか？(Y or N)";
    public static final String BURST="バースト";
    public static final String INPUT_ERROR="Y か N を入力してください。";
    public static final String DEALERS_TURN="ディーラーの番です。";
    public static final String YOU_WIN="あなたの勝ちです";
    public static final String YOU_LOSE="あなたの負けです";
    ...
    public static final String SEVEN_CARD = "セブンカード! 賭けポイント10倍!";
    public static final String SIX_CARD = "シックスカード! 賭けポイント5倍!";
    public static final String THREE_SEVEN = "スリーセブン! 賭けポイント10倍!";
